import svgPaths from "./svg-o0h0p2ou9s";
...
function Dashboard() {
  return (
    <div className="absolute bg-[#101828] content-stretch flex flex-col gap-[24px] items-start left-[288px] top-[97px] right-0 bottom-0 overflow-auto px-6 py-6" data-name="Dashboard">
      <Container />
      <SummaryCards />
      <Container1 />
      <Card5 />
